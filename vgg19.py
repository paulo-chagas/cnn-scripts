...
print "\n"
print "Creating model VGG19 --  no weights"
base_model = VGG19(weights=None, include_top=False, input_shape=(224,224,3))
weights_imagenet = '../weights/vgg19_weights_tf_dim_ordering_tf_kernels_notop.h5'
...
print "Done\n"
print "Saving model"
model.save(path_models+"vgg19_retrained_top_layers")
...
# convolutional layers from vgg19. We will freeze the bottom N layers
...
# we train our model again (this time fine-tuning the top 1 vgg19 blocks
...
print "Done\n"
print "Saving model"
model.save(path_models+"vgg19_retrained_model")
print "Model saved"
