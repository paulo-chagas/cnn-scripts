...
log.append("img_width, img_height = "+str(img_width) + ", " + str(img_width))
...
weights_imagenet = '../weights/vgg16_weights_tf_dim_ordering_tf_kernels_notop.h5'
...
print "Done\n"
print "Saving model"
model.save(path_models+"vgg16_retrained_top_layers")
...
# we train our model again (this time fine-tuning the last conv block
...
print "Done\n"
print "Saving model"
model.save(path_models+"vgg16_retrained_model")
print "Model saved"
